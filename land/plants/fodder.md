...
| mid-story fodder | [[calliandra calothyrsus]] | 80 | 2 × 2 m | primary protein hedge, sheep priority | cuttings |
...
70 ares walled silvopasture at [[gesing]], ~1400m. controlled environment for [[sheep]]. rotational browse, never continuous graze.

### spatial structure

```
wall perimeter — gamal every 2m outer ring, calliandra calothyrsus inner ring

canopy — samanea saman × 8 at 10×10m, inga edulis × 12 at 7×7m

napier alleys across contour, 1m spacing
  between alleys: batat + arachis pintoi ground layer

trichanthera + tithonia block ~600m² — cut-and-carry bank
cajanus + amaranthus — interrow broadcast, rotate annually
sorghum — seasonal broadcast ~400m², stover for silage
morus cluster — 6 trees, rotational 3-day browse
musa — clumps near shade trees, dry-season water reserve
```

### seasons

- **wet**: napier primary, amaranthus + cajanus supplement
- **dry**: tithonia + trichanthera bank, musa pseudostem, inga pod husks

### capacity

~9,300 kg DM/year → **14–16 sheep year-round**