...
Utility consumption is billed separately from the area revenue charge and any rent under [[annex e century index|Annex E]] — Annex E and the deferred-balance rate under [[hak sewa deed]] §3.2 govern land and rent only, never utility usage. Metering and tariff are set district by district as each system is commissioned; until then a Plot on the off-grid solar/rainwater/Starlink base pays no separate utility charge beyond the service charge already provided for elsewhere in the deed.
