...
| field | source | note |
|---|---|---|
| Parcel (Annex A row) | Annex A | the master title this Plot is carved from |
...
Where this Annex B and a later BPN-registered *Surat Ukur* disagree on boundary or area, the *Surat Ukur* prevails for anything BPN itself certifies (titled parcels, post-*pemecahan* Plots); this annex prevails for anything not yet certified (an indicative Plot inside a still-whole master title). The Register carries the correction either way — see [[annex-a-estate-registry|Annex A]] §4.
