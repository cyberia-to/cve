...
**2.4** This Agreement takes effect, and its Effective Date arises, only upon Closing (as defined in [[gms director appointment]] [§4](/cyber-valley/cve/legal/gms-director-appointment#4-closing-single-condition-package)) — that is, only once the GMS resolution, the executed share sale, the updated share register, and the Incoming Director's written acceptance of office have all occurred. If this Agreement is signed before Closing, it is binding as an agreement to take effect on those terms, but no protection or obligation under it arises until Closing occurs. If Closing does not occur, this Agreement terminates automatically and no Party has any claim under it.
...
- **Fedorov's equity isn't in this document, by design.** The 1% (80/8,040 shares) he receives at Closing is priced and conditioned entirely in [[share sale entry]] (par, Rp 200,000,000) and bound to this appointment via [[gms director appointment]] [§3.4](/cyber-valley/cve/legal/gms-director-appointment#3-resolutions)/[§4](/cyber-valley/cve/legal/gms-director-appointment#4-closing-single-condition-package); the real consideration actually paid ($40,000) is receipted in [[entry payment side letter]] — no repayment or re-transfer attaches to the shares ([[president director]] [§8](/cyber-valley/cve/legal/president-director#8-exit)). Post-Closing the cap table is Voinova 49% / Starodubtsev 50% / Fedorov 1% — this Agreement's own "Owners" vs. "Incoming Director" framing (Parties, above) doesn't reflect that, since Fedorov gives no indemnity here and isn't an "Owner" for its purposes, even though he ends up a shareholder from the same Closing.
- **Effective Date vs. Closing — resolved.** [Article 2.4](#article-2-appointment-of-the-incoming-director) now ties the Effective Date to Closing under [[gms director appointment]] [§4](/cyber-valley/cve/legal/gms-director-appointment#4-closing-single-condition-package) (GMS resolution + share sale + register update + acceptance of office), so Fedorov is never in office without the indemnity in force, or vice versa.
- **[[president director]] [§13](/cyber-valley/cve/legal/president-director#13-legal-defence-narrow-indemnification) overlap.** [[president director]] [§13](/cyber-valley/cve/legal/president-director#13-legal-defence-narrow-indemnification) ("Shield") independently states a softer, less formal disclosure/liability standard for the pre-appointment period. [Article 6](#article-6-no-limitation-by-knowledge-investigation-or-reliance) here is deliberately strict (only [Appendix A](#appendix-a-owners-due-diligence-questionnaire-and-answers-english-translation)/B/C-confirmed items count as disclosed); §13's looser wording is worth narrowing to defer to this Agreement's definition, so the two don't offer competing standards for what counts as "disclosed".
