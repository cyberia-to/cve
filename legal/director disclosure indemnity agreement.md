...
Personal instrument from the **Owners** (Alisa Voinova, Dmitry Starodubtsev) to the **Incoming Director** (Oleksandr "Alex" Fedorov): full disclosure of Company and land liabilities, backed by an uncapped joint-and-several indemnity, so Alex can accept the Director role and deal with third parties on the Land without inheriting undisclosed risk. **Supplements, does not replace**, the [[rups|RUPS]] + notarial appointment in [[gms director appointment]] ([Article 2.2](#article-2-appointment-of-the-incoming-director)).
...
- **Effective Date vs. Closing — resolved.** [Article 2.4](#article-2-appointment-of-the-incoming-director) now ties the Effective Date to Closing under [[gms director appointment]] §4 (GMS resolution + share sale + register update + acceptance of office), so Alex is never in office without the indemnity in force, or vice versa.
