...
| Date | 2026-08-27 |
| What the Holder was shown | Instrument B (annual leasehold): 1 year at 30% down and a 6% fee, or 5 years at 35% down and a 15% fee; balance in equal instalments, no interest, no index |
| Binding vs informational | The instalment mechanic and the no-rate, no-index treatment of the balance are commitments — [[hak sewa template]] 3.0 says commitments bind through the deed. Wave pricing, KPI figures and the pricer widget's live output are current-state information and are not frozen by this entry. |
