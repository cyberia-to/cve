...
1. This Agreement is made to supplement [Articles 5](/cyber-valley/cve/legal/articles-of-association#article-5-shares) and [7](/cyber-valley/cve/legal/articles-of-association#article-7-transfer-of-shares) of the Company's [[articles of association|Articles of Association]] with contractual terms binding between the Shareholders personally, including tag-along rights, a closed list of grounds for withholding consent to a transfer, and the mandatory dividend cadence.
...
**Cadence.** Distributable cash under item 4 is distributed to the Shareholders every moon cycle (one new moon to the next), and in no event less often than once per calendar quarter, as an interim dividend permitted by [[articles of association]] [Article 18(2)](/cyber-valley/cve/legal/articles-of-association#article-18-dividends). Distribution is the rule between the Shareholders; retention is the exception and requires their unanimous written agreement.
...
**Tests — the only grounds to withhold.** A distribution may be withheld only where one of the following fails, and the failure is notified in writing stating which test and the figures:
   ...
   a. after payment, the net assets of the Company remain at least the issued and paid-up capital plus the statutory reserve accumulated under [[articles of association]] [Article 19](/cyber-valley/cve/legal/articles-of-association#article-19-use-of-reserves);
...
1. A Shareholder shall not lend money to the Company, and the Company shall not accept loan financing from a Shareholder or from an affiliate of a Shareholder, except with the unanimous prior written consent of all Shareholders.
2. Capital is contributed through an increase of the issued capital with the pre-emptive right under [Article 4(3)](/cyber-valley/cve/legal/articles-of-association#article-4-capital) of the [[articles of association|Articles of Association]].
3. Where consent under paragraph (1) is given, the same resolution shall fix where repayment of that loan sits in the order of application under Article 4 of this Agreement. Absent such a determination, repayment ranks after distributable cash.
...
## Article 14 — Binding on shareholders and successors

1. Each Shareholder is bound by this Agreement for so long as it holds shares in the Company, save for Articles 9, 13 and 17, which continue to bind it after it ceases to hold shares.
...
## Article 16 — Severability and change of law
...
| [[ceo-commissions-addendum]] | land commissions, referral and raise fees, revenue share |
...
| 5 death and incapacity | master template Art 5.6, valuation mechanism added |
| 6 no shareholder financing | new — the negative of master template Art 3, which was rejected |
| 7 information rights | master template Art 10.5 |
| 8 convening a GMS | master template Art 9.2, recast as a shareholder undertaking |
| 9 warranties | master template Art 12, recast for individuals, sanctions and source of funds added |
| 10 covenants | master template Art 13, non-compete deliberately omitted |
| 11 assignment | master template Art 18, affiliate change-of-control loophole closed |
| 12 notices | master template Art 22, email-first instead of registered post |
| 13 disputes | master template Art 16, BIAMC replaced by [[bani|BANI]] to match the pack |
| 14 binding on shareholders | master template Art 23, survival carve-out added |
| 15 entire agreement | master template Art 24, narrowed by Schedule 1 |
| 16 severability | master template Art 20 |
| 17 non-waiver | master template Art 21 |
| 18 miscellaneous | [[shareholders agreement]] Art 5, language rule added |

Rejected from the master template: Art 1.3 (agreement prevailing over the constitution), Art 3 (shareholder loans), Art 5.2 (buy-out at valuer's price instead of the offered price), Art 5.3.b (free transfer to affiliates), Art 7.7–7.8 (USD thresholds and unanimity), Art 11 (100% reserve, 30% payout), Art 14 (confidentiality — the graph publishes this pack), Art 17 (termination on failure to obtain licences), Art 19.2 (English prevailing).
