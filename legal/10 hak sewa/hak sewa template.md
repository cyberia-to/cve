...
Two instruments per Plot form one transaction. The notary executes [[hak sewa simple]], the eight-clause *akta sewa*; the same parties sign this agreement alongside it. The two state their shared terms identically, and this agreement governs every other term. Both are executed in Bahasa Indonesia and English, the Indonesian text prevailing; the Director signs under Articles of Association Pasal 12(2)(c). Schedule 3 maps this text to the notary's long format, [[perjanjian sewa menyewa template]].
...
| Community Rules | the [[cyber-valley/policies/community rules\|Community Rules]] page |
...
| Permitted Use | the [[cyber-valley/policies/permitted use\|Permitted Use]] page |
| Plot price | the price of the Plot recorded in the recitals, L₀ for Annex E (Century Index) |
| Premium | the share of the Plot price paid at signing, recited as a percentage and a sum. At 100% the Plot is paid in full; below 100% the rest is paid by instalments under the century index (3.2) |
...
| Approved design | the design approved under 8.1 and protected under 10.6 |
...
| satoshi | one hundred-millionth of a bitcoin: 1 satoshi = 0.00000001 BTC |
...
| symbol | meaning |
|---|---|
| L(T) | the renewal price |
| L₀ | the Plot price in the recitals |
| T₂ | the renewal Term, in years |
| T₁ | the first Term, in years |
| I(T) | the dollar value of the Annex E (Century Index) quantities on the renewal date |
| I(t₀) | the dollar value of the same quantities on the signing date |
...
4.5 Assignment fee. 2.0% of the price the assignee pays, payable on notice. The conditions the assigning Holder meets reduce it to a minimum of 1.0%: every sale on the Estate funds the city. Succession under 4.10 carries no fee.
...
4.8 Register. The Landowner keeps the register of leases; the entry is evidence of the Holder's rights. Each lease and each assignment is recorded as a particle in [[soft3/cybergraph|cybergraph]], and a cyberlink joins every assignment to the lease it transfers. The state of a lease is public; the identity of the Holder stays in the Company's file. On divergence the notarial deed and the register prevail.
...
6.2 Annex B (Plot Boundary), completed and initialled, defines the boundaries this Part refers to.
...
1. Holding charge: [0.5]% of the Plot price per month of overrun, rising by [0.25] percentage points every 6 months, paid to the biosphere and desa reserves under the [[cyber-valley/policies/biosphere and desa reserves|biosphere and desa reserves]] page.
...
10.1 The Design Code binds every Holder, track and zone. It is a graph page that the city and its residents amend by proposal and vote under 10.5.
...
11.1 Membership is compulsory for every Holder and survives assignment and title upgrade. Every member votes in the Council. Company shares add weight under 11.1.1; they may be bought at any time at the price per share the [[company licences|Company page]] publishes from the Company's current valuation. A *perkumpulan* is constituted in Phase 3 to hold shared infrastructure.
...
| symbol | meaning |
|---|---|
| base | the participant's entry weight |
| A | the area of the participant's Plots in the district |
| D | the area of the district |
...
11.2 Protection of what is built. Completed Improvements keep every right they were built with; an amendment of the Design Code or the Community Rules reaches them where it keeps or improves their position.

11.3 Initiative. A proposal carrying [10]% of district weight is answered by the Board of Directors in writing in the Register within 30 days; silence is acceptance, subject to 10.2 and 11.2. Proposals carried under 10.5 amend the Design Code and the Community Rules.

11.4 Service charge. The actual cost of operating and maintaining Z4 and Z8 infrastructure serving the district, apportioned by Plot area, capped at [1]% of the Plot price per year indexed under Annex E (Century Index). The Landowner publishes the budget before each year and the audited account within 90 days after it; a Holder may inspect the records on 30 days' notice. Trails and commons are open to residents under the service charge.

11.5 Each Plot is self-sufficient in energy, water and waste under the Design Code and Annex F (Utilities, Access and Mobility). The Landowner provides legal access to the Plot by the estate roads from the mobility hub. Where the Landowner opens a connection to an estate system, it does so for the period, capacity and tariff the Register publishes, and the connection ends on the date stated. Cars and combustion vehicles stop at the mobility hub; small electric vehicles move freely inside: e-bikes, e-scooters and electric carts. Annex F (Utilities, Access and Mobility) states access, parking, construction logistics and waste removal.
...
12.3 After any title change the Design Code, the Community Rules and Council membership continue through covenants in the AJB, easements over access and utilities, and Council membership as a condition of sale. Company shares the Holder has bought stay with the Holder.
...
13.3 Disclosed at signing and initialled: the term of the Title and its renewal risk; zoning status; the unregistered nature of hak sewa; the footprint of this Plot in square metres: 10% of its area; the Rp 5,000,000,000 threshold of 12.1.2; the core closed to cars and combustion vehicles and open to small electric vehicles and electrical equipment under Annex F (Utilities, Access and Mobility).

---

## Part 14. Licences

14.1 The Landowner warrants a valid NIB at its registered address in Gesing, with every KBLI of Articles of Association Pasal 3 issued and in force, as the [[company licences]] page records.
...
| deprivation beyond 180 days, or incurable | termination for the Landowner's default: the Unamortised premium, the Improvements at independent valuation, and the Holder's direct loss |

---

## Part 16. Default, termination, end of term

16.1 Default and cure, equal for both sides. A party in breach receives written notice naming the breach. Cure periods: payment, 30 days; other breaches, 60 days; breaches whose cure needs a permit or works, 180 days while diligently pursued. A breach uncured past its period is a material default. The Holder may assign under Part 4 during any cure period, the assignee taking the cure period as it stands. Repeated breach of one Community Rules standard, remediated once and recurring within 12 months, is a material default on the second notice.
...
17.2 Adat. The Holder complies with the *awig-awig* of the *desa adat*, the *banjar* and *subak* arrangements affecting the Estate, ceremonial access and processional routes, and the customary contributions of residents, as the adat section of the Community Rules page records them. The Landowner discloses them before signing.
...
Figures in brackets in the text:
...
| 3.2 | early redemption | remaining rent at current R(t), discounted at the base rate of the offer of record |
...
| 4.5 | referral threshold | 3 referred Holders in good standing, fee at 1.0% |
