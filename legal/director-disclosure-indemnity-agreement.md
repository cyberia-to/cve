...
- **Payment/contracting limits:** any contract with a value above **2% of the issued capital (modal ditempatkan)** requires the Commissioner's prior approval. On top of that, structural control — any disbursement from the main revenue account requires two signatures (two-to-sign).
