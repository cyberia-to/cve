...
icon: "🛡️"
---
# Director Appointment — Full Disclosure & Indemnification Agreement
...
- Undocumented verbal debt: **USD 5,000** (0.1% of valuation) owed to a former partner, payable on receipt of Alex's share payment — informal, unwritten, nominee-flavored.
- Shareholders' agreement question: **left unanswered**.
- Land disputes: "resolved, awaiting certificates" — Parcels 0, 3.1, 13 specifically named as unfinished.
- Bookkeeping contract **not shown** ("informal subscription basis").
- Two leased buildings in the village center, unused, leases running to **31.12.2032**.
- Company money funds construction/events businesses registered in **employees' names**, not the Company's.

## Appendix B — Land portfolio (Desa Gesing, 19 numbered parcels)
