...
Companion to [[share sale entry]] (the notarial deed). This letter records the payment actually made between the parties for the entry stake — a receipt fixing the real price behind the deed's recital. Nothing attaches to the shares themselves: they are the Buyer's outright, and no repayment or re-transfer arises on any exit ([[ceo]] [§8](/cyber-valley/cve/legal/ceo#8-exit) — no buyout, no buyback).
