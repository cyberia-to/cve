...
- supply pipes: food-grade PP-R80/PP-R100, PN16 minimum; no PVC, no galvanized steel, no lead solder in potable lines; fittings butt-fusion or electrofusion welded, no glued slip joints buried or concealed
- rainwater collection: food-grade or stainless-steel catchment surfaces only, no asphalt-based or zinc-treated roofing; first-flush diverters on every roof catchment, minimum 1 L per 10 m² of collection area, auto-resetting; storage in food-grade polyethylene or ferrocement with lime render, no fiberglass with styrene binders; no open reservoirs in residential or food-production zones
- greywater: on-site treatment before soil discharge (constructed wetland, living machine, or trickling filter) to BOD < 30 mg/L; blackwater: closed composting system or biodigester, no direct discharge to soil or waterways; greywater and blackwater plumbed separately from the first fixture

## D2. Light

Source: [[light policy]].

- all outdoor fixed lighting: 2200 K or warmer; blue-enriched lighting above 3000 K prohibited outdoors anywhere on the estate
- all outdoor luminaires fully shielded, full-cutoff IES classification, zero upward emission; no floodlights on canopy or forest understory; path lighting preferred as ground-level bollards at ≤0.6 m over pole-mounted fixtures
- intensity limits by zone as set in the source page; a Holder's fixture plan is checked against the zone table before SLF
...
| zone | day (07:00–22:00) | night (22:00–07:00) |
|---|---|---|
| residential | 55 dB(A) | 40 dB(A) |
| public / commercial | 65 dB(A) | 50 dB(A) |
| productive / workshop | 75 dB(A) | prohibited |
| forest / conservation | 45 dB(A) | 35 dB(A) |

Measured at the nearest affected boundary, not at the source. Events above 70 dB(A) at the event perimeter require 48-hour notice to all residents within 300 m. Amplified music outdoors is permitted 10:00–23:00 only, cutting off at 23:00 regardless of the event's own schedule; sub-80 Hz frequencies are level-limited so bass is not audible beyond the perimeter.

## D5. Air

Source: [[air policy]].

- open burning of synthetic materials, agricultural waste-disposal burning and municipal solid waste is prohibited at all times
