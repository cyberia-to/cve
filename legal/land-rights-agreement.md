...
8.1 Community Council. Contractual body; membership compulsory for all Holders, all tracks; survives assignment and title upgrade. Voting weight follows what a Holder has built and contributed: weight = √(area) × contribution × (1 + links), normalised across the district, capped at 10% per Holder and recomputed every moon cycle. The factors are stated in [11.1.1](/cyber-valley/cve/legal/hak-sewa-deed#part-11-community-council) of the deed. A separate legal vehicle (*perkumpulan*) is constituted in Phase 3 to hold shared infrastructure, on the community land trust path in the strategy.
