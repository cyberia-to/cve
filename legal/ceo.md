...
| trigger | rule |
|---|---|
| **Removal from Director office** (by resolution of the shareholders) | Removal takes effect **immediately**. Bought back are only the shares the CEO **bought from the founders**. Option shares exercised under [§6](#6-options-up-to-10-at-4m-sale-from-founders-only) are bought at their value on the **company valuation at the date of removal**, with a floor of **USD 40,000 per 1%**, being the strike he paid. The entry stake is repaid at the price in the [[entry payment side letter]] — USD 40,000 for the 80 shares — against transfer of those shares back to the Seller. Cause of removal does not change either price. |
...
| **The valuation** | The price per share in the most recent arm's-length sale of shares to a third party within the 12 moon cycles before the removal date. Where there is no such sale, an independent valuer agreed by the parties, whose determination binds both. |
| **Payment of the buyout** | A debt of the buyer, not a condition of removal. The amount is **fixed in US dollars at the removal date** and paid in **12 equal moonly instalments**. Each instalment is converted to IDR at [JISDOR](https://www.bi.go.id/en/statistik/informasi-kurs/jisdor/default.aspx) on its payment date, as [[uu 7-2011 mata uang|UU 7/2011]] requires — the dollar figure does not move, only the conversion does, so the CEO carries no rupiah devaluation risk. Late payment accelerates the whole balance. Secured by the instrument chosen under [9B.7](/cyber-valley/cve/legal/land-rights-agreement#9b-title-warranties-negative-pledge-and-indemnity) of [[land-rights-agreement]]. |
...
| Founders (DS / AV) | option sellers; buyout funding obligors under [§8](#8-exit) (see [[shareholders agreement]] Art. 5) | |
| CEO | offer | |
