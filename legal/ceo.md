...
| **Payment of the buyout** | A debt of the buyer, not a condition of removal. Denominated at the removal date in [[century index]] basket quantities and paid in **12 moonly instalments**: each instalment recomputed on the index, collar +35% / −15% per year, dual floor (no fewer satoshi and no fewer dollars than at the removal date), settled in IDR at JISDOR on the invoice date (UU 7/2011), with the CEO's right to recompute any invoice from public sources within 30 days (thesis T5). Secured by the instrument chosen under 9B.7 of [[land-rights-agreement]]; late payment accelerates the balance. |
