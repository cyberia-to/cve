...
| trigger | rule |
|---|---|
| **Removal from Director office** (by founders, shareholders, or any party other than the CEO) | Removal takes effect **immediately**. Bought back are only the shares the CEO **bought from the founders** — the entry stake and any option shares exercised under [§6](#6-options-up-to-10-at-4m-sale-from-founders-only) — at their value on the **company valuation at the date of removal**, with a floor of **USD 40,000 per 1%** of those shares, being the price he paid for them. Cause of removal does not change the price. |
