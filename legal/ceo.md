...
| trigger | rule |
|---|---|
| **Removal from Director office** (by founders, shareholders, or any party other than the CEO) | Removal takes effect **immediately**. The CEO's entire holding — the entry stake, option shares under [§6](#6-options-up-to-10-at-4m-sale-from-founders-only) and ladder equity under [§7](#7-kpi-ladder-ds-av-10-founders-company-1b) — is bought out at its value on the **company valuation at the date of removal**, with a floor of **USD 40,000 per 1% held** (the USD 4,000,000 valuation at which the option strike is set). Cause of removal does not change the price. |
